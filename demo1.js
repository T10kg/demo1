function SubmitLogin() {
   $(".submitBtnLogin").click(function(n) {
       var t, i, r, u;
       if ($("#preloader").show(), n.preventDefault(), t = $("#loginForm #UserName").val(), i = $("#loginForm #Password").val(), $("#loginForm small").remove(), IsStringNullEmpty(t) == !0) return $("#preloader").fadeOut(), genErrorMsg("#loginForm #UserName", "*Vui lòng vào tài khoản");
       if (IsStringNullEmpty(i) == !0) return $("#preloader").fadeOut(), genErrorMsg("#loginForm #Password", "*Vui lòng vào mật khẩu");
       r = $('input[name="X-CSRF-TOKEN-OurAppName').val();
       u = $("#loginForm").serializeArray();
       $.ajax({
           url: "/daily/Login/SubmitLogin",
           type: "POST",
           headers: {
               "X-CSRF-TOKEN-OurAppName": r
           },
           data: u,
           beforeSend: function() {
               $("#preloader").show()
           ...
           success: function(n) {
               $("#preloader").fadeOut();
               n.code > 0 ? window.location.href = n.islivechat ? "/daily/ctv-livechat" : "/daily/" : n.code == -1004 ? $(".errorLocation").html("<small class='errorLoca'>*" + n.msg + " <\/small>") : ToBuildErrorPopup(n.redirecturl, n.msg)
           },
           error: function() {
               $("#preloader").fadeOut();
               alert("Có lỗi trong quá trình đặt nhập, vui lòng thử lại sau. #ajax")
           },
           complete: function() {
               CreateTokenCaptcha()
           }
...
function GetLatLongSubmitLogin() {
   var n = $("#IsCtvLiveChat").val(),
       t = $("#IsMobileApp").val();
   n == "True" || t == "True" ? $(".submitBtn").click(function(n) {
       n.preventDefault();
       $(".submitBtnLogin").click()
   }) : $(".submitBtn").click(function(n) {
       if (n.preventDefault(), $(".errorLocation .errorLoca").remove(), navigator.geolocation) navigator.geolocation.getCurrentPosition(function(n) {
           const r = {
           ...
           $("#preloader").fadeOut();
           $(".errorLocation").html("<small class='errorLoca'>*Vui lòng bật chia sẻ vị trí để tiếp tục đăng nhập.<\/small>");
           return
       });
       else {
           $("#preloader").fadeOut();
...
function genErrorMsg(n, t) {
   var i = $getParent(n);
   IsStringNullEmpty(t) == !1 ? ($(i).append("<small class='error'>" + t + "<\/small>"), $(n).focus(), $(n).addClass("notvalid")) : (i.find("small").remove(), $(n).removeClass("notvalid"))
}
...
function IsStringNullEmpty(n) {
   return n == "" || n == undefined
}

function InitToggleUserInfo() {
   $(".behind-lg .col-right span").click(function() {
       $(".behind-lg .col-right span").toggleClass("active");
       $(".col-right ul").toggle()
   })
}
...
function CheckUserLogin() {
   $.ajax({
       url: "/daily/Login/CheckUserLogin",
       type: "POST",
       beforeSend: function() {},
       success: function(n) {
           n.isLogin && !n.islivechat ? ($("header").addClass("behind-lg"), $("header .col-right").show(), $("header .col-right span").html(n.fullName), $("input#UserName").val(n.userName), InitToggleUserInfo(), LogoutUserLogin()) : ($("header").removeClass("behind-lg"), $("header .col-right").hide(), $("header .col-right span").html(""))
       },
       error: function() {}
   })
}
...
function LogoutUserLogin() {
   $(".behind-lg .logout").click(function() {
       $.ajax({
           url: "/daily/Login/LogoutUserLogin",
           type: "POST",
           beforeSend: function() {},
           success: function(n) {
               window.location.href = n.isliveChat ? "/daily/" : "/";
               CheckUserLogin()
           },
           error: function() {}
       })
...
function ChangePassword() {
   $(".submitChangePassword").click(function(n) {
       var s, h, c;
       n.preventDefault();
       $("#changePassword small").remove();
       var o = "#changePassword #OldPassword",
           t = "#changePassword #NewPassword",
           u = "#changePassword #ReNewPassword";
       if (IsStringNullEmpty($(o).val()) == !0) return genErrorMsg(o, "*Vui lòng nhập mật khẩu cũ");
       if (IsStringNullEmpty($(t).val()) == !0) return genErrorMsg(t, "*Vui lòng nhập mật khẩu mới");
       if ($(t).val().length < 8) return genErrorMsg(t, "*Mật khẩu phải có ít nhất 8 ký tự.");
       var f = /\d+([\/.]\d+)?/g,
           l = /\d+([\/.]\d+)?/g,
           a = /[^A-Za-z 0-9]/g,
           i = $(t).val();
       if (console.log(i.match(f)), i.match(f) == null || i.match(f) == undefined) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự số.");
       for (var v = i.length, r = 0, e = !1; r < v; r++)
           if (i.charAt(r) === i.charAt(r).toUpperCase() && !e && !i.charAt(r).match(l) && !i.charAt(r).match(a)) {
               e = !0;
               break
           }
       if (!e) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự in hoa.");
       if (s = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/, !s.test($(t).val())) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự đặc biệt.");
       if (IsStringNullEmpty($(u).val()) == !0) return genErrorMsg(u, "*Vui lòng nhập lại mật khẩu mới");
       if ($(t).val() != $(u).val()) return genErrorMsg(u, "*Mật khẩu không khớp");
       h = $('input[name="X-CSRF-TOKEN-OurAppName').val();
       c = $("#changePassword").serializeArray();
       $.ajax({
           url: "/daily/Login/ChangePassword",
           type: "POST",
           headers: {
               "X-CSRF-TOKEN-OurAppName": h
           },
           data: c,
           beforeSend: function() {
               $("#preloader").show()
           ...
           success: function(n) {
               $("#preloader").hide();
               n.code > 0 ? (alert(n.msg), window.location.href = n.islivechat ? "/daily/login?livechat=true" : "/daily/login") : alert(n.msg)
           },
           error: function() {
               $("#preloader").hide();
               alert("Hệ thống đang gặp sự cố vui lòng thử lại sau. #ajax")
           },
           complete: function() {
               CreateTokenCaptcha()
           }
...
function SendOTPForgetPassword() {
   $(".btnsendOTpforgetPassword").click(function(n) {
       var i, t, r, u, f;
       if (n.preventDefault(), $("#forgetPassword small").remove(), i = "#forgetPassword #UserName", t = "#forgetPassword #Phone", IsStringNullEmpty($(i).val()) == !0) return genErrorMsg(i, "*Vui lòng nhập vào tài khoản");
       if (IsStringNullEmpty($(t).val()) == !0) return genErrorMsg(t, "*Vui lòng nhập vào số điện thoại");
       if (r = /^((0(\d){10})|(0(\d){9}))$/, !r.test($(t).val())) return genErrorMsg(t, "*Vui lòng nhập số điện thoại hợp lệ.");
       u = $('input[name="X-CSRF-TOKEN-OurAppName').val();
       f = $("#forgetPassword").serializeArray();
       $.ajax({
           url: "/daily/Login/SendOTPForgetPassword",
           type: "POST",
           headers: {
               "X-CSRF-TOKEN-OurAppName": u
           },
           data: f,
           beforeSend: function() {
               $("#preloader").show()
           ...
           success: function(n) {
               $("#preloader").hide();
               n.code < 0 ? n.code == -99 ? $(".errorArea").html("<small class='errorLoca'>*" + n.msg + " <\/small>") : alert(n.msg) : ($("#forgetPassword").html(n), UpdatePasswordWithOTP())
           },
           error: function() {
               $("#preloader").hide();
               alert("Hệ thống đang gặp sự cố vui lòng thử lại sau. #ajax")
...
function UpdatePasswordWithOTP() {
   $(".btnUpdatePasswordOTP").click(function(n) {
       var s, h, c;
       n.preventDefault();
       $("#forgetPassword small").remove();
       var u = "#forgetPassword #OTP",
           t = "#forgetPassword #NewPassword",
           f = "#forgetPassword #ReNewPassword";
       if (IsStringNullEmpty($(u).val()) == !0) return genErrorMsg(u, "*Vui lòng nhập vào OTP");
       if ($(u).val().length < 6) return genErrorMsg(u, "*Vui lòng nhập đủ 6 ký tự");
       if (IsStringNullEmpty($(t).val()) == !0) return genErrorMsg(t, "*Vui lòng nhập mật khẩu mới");
       if ($(t).val().length < 8) return genErrorMsg(t, "*Mật khẩu phải có ít nhất 8 ký tự.");
       var o = /\d+([\/.]\d+)?/g,
           l = /\d+([\/.]\d+)?/g,
           a = /[^A-Za-z 0-9]/g,
           i = $(t).val();
       if (i.match(o) == null || i.match(o) == undefined) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự số.");
       for (var v = i.length, r = 0, e = !1; r < v; r++)
           if (i.charAt(r) === i.charAt(r).toUpperCase() && !e && !i.charAt(r).match(l) && !i.charAt(r).match(a)) {
               e = !0;
               break
       ...
       if (!e) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự in hoa.");
       if (s = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/, !s.test($(t).val())) return genErrorMsg(t, "*Mật khẩu phải chứa ký tự đặc biệt.");
       if (IsStringNullEmpty($(f).val()) == !0) return genErrorMsg(f, "*Vui lòng nhập lại mật khẩu mới");
       if ($(t).val() != $(f).val()) return genErrorMsg(f, "**Mật khẩu không khớp");
       h = $('input[name="X-CSRF-TOKEN-OurAppName').val();
       c = $("#forgetPassword").serializeArray();
       $.ajax({
           url: "/daily/Login/UpdatePasswordWithOTP",
           type: "POST",
           headers: {
               "X-CSRF-TOKEN-OurAppName": h
           },
           ...
           success: function(n) {
               $("#preloader").hide();
               n.code > 0 ? (alert(n.msg), window.location.href = n.islivechat ? "/daily/login?livechat=true" : "/daily/login") : alert(n.msg);
               n.code == -99 && $(".errorArea").html("<small class='errorLoca'>*" + n.msg + " <\/small>")
           },
           error: function() {
               $("#preloader").hide();
               alert("Hệ thống đang gặp sự cố vui lòng thử lại sau. #ajax")
...
function RedirectOldUrl() {
   if (location.href.includes("/ctv")) return window.location.href = "/daily"
}

function IsNumberKey(n) {
   var t = n.which ? n.which : n.keyCode;
   return t == 47 ? !0 : t == 46 ? !1 : t != 46 && t > 31 && (t < 48 || t > 57) ? !1 : !0
}

function SubmitLoginEmployee() {
   $(".submitBtnEmployee").click(function(n) {
       var t, i, r, u;
       if (n.preventDefault(), t = $("#loginForm #UserName").val(), i = $("#loginForm #Password").val(), $("#loginForm small").remove(), IsStringNullEmpty(t) == !0) {
           alert("*Vui lòng vào tài khoản");
           return
       }
       if (IsStringNullEmpty(i) == !0) {
           alert("*Vui lòng vào mật khẩu");
           return
       }
       r = $('input[name="X-CSRF-TOKEN-OurAppName').val();
       u = $("#loginForm").serializeArray();
       $.ajax({
           url: "/daily/Login/SubmitLoginEmployee",
           type: "POST",
           headers: {
               "X-CSRF-TOKEN-OurAppName": r
           },
           ...
           success: function(n) {
               if ($("#preloader").hide(), n.code > 0) window.location.href = "/daily/employee";
               else {
                   var t = "";
                   n.code == -44 ? t = "/daily/login?livechat=true" : n.code == -55 ? t = "/daily/login" : n.code == -11 && (t = n.site == 2 ? "https://www.dienmayxanh.com/daily/login-nhan-vien" : "https://www.thegioididong.com/daily/login-nhan-vien");
                   ToBuildErrorPopup(t, n.msg)
               }
           },
           error: function() {
               $("#preloader").hide();
...
function CreateTokenCaptcha() {
   grecaptcha.ready(function() {
       grecaptcha.execute("6LdM-rUaAAAAAGt03Gb2u5XNu9W5Emyn5le13uJV", {
           action: "submitLoginPartner"
       }).then(function(n) {
           $("#reCaptchaToken").val(n)
       })
   })
}
...
function ToBuildErrorPopup(n, t) {
   $(".popup-error").show();
   $(".popup-error .popup-error__content").html("");
   $(".popup-error .popup-error__content").html(t);
   $(".popup-error .popup-error__closePop").attr("data-url", n);
   $(".popup-error .popup-error__closeBut").attr("data-url", n);
   InitClosePopup()
}

function InitClosePopup() {
   $(".popup-error .popup-error__closePop").click(function() {
       $(".popup-error").hide();
       var n = $(this).attr("data-url");
       n !== "" && n !== undefined && (window.location.href = n)
   });
   $(".popup-error .popup-error__closeBut").click(function() {
       $(".popup-error").hide();
       var n = $(this).attr("data-url");
       n !== "" && n !== undefined && (window.location.href = n)
   })
   ...
   function fi(n, t, r) {
       ...
       if ("string" == typeof t) {
           if (se.test(t)) return i.filter(t, n, r);
           t = i.filter(t, n)
       }
   ...
   function li(n, t, r, u) {
       ...
       if (i.isArray(t)) i.each(t, function(t, i) {
           r || eo.test(n) ? u(n, i) : li(n + "[" + ("object" == typeof i ? t : "") + "]", i, r, u)
       });
   ...
   i.fn = i.prototype = {
       ...
       init: function(n, u, f) {
           ...
           if (!n) return this;
           if ("string" == typeof n) {
               if (e = "<" === n.charAt(0) && ">" === n.charAt(n.length - 1) && n.length >= 3 ? [null, n, null] : pf.exec(n), !e || !e[1] && u) return !u || u.jquery ? (u || f).find(n) : this.constructor(u).find(n);
               if (e[1]) {
   ...
   i.extend({
       ...
       type: function(n) {
           return null == n ? n + "" : "object" == typeof n || "function" == typeof n ? ot[vf.call(n)] || "object" : typeof n
       },
       ...
       parseJSON: function(r) {
           return n.JSON && n.JSON.parse ? n.JSON.parse(r) : null === r ? r : "string" == typeof r && (r = i.trim(r), r && wf.test(r.replace(kf, "@").replace(df, "]").replace(bf, ""))) ? Function("return " + r)() : (i.error("Invalid JSON: " + r), t)
       },
       parseXML: function(r) {
           var u, f;
   ...
   i.Callbacks = function(n) {
       n = "string" == typeof n ? ni[n] || ie(n) : i.extend({}, n);
       var s, f, c, e, o, l, r = [],
           u = !n.once && [],
           a = function(t) {
   ...
   var d, or, ii = /[\t\r\n\f]/g,
       re = /\r/g,
       ue = /^(?:input|select|textarea|button|object)$/i,
       fe = /^(?:a|area)$/i,
   ...
   i.fn.extend({
       ...
       val: function(n) {
           ...
           })) : f ? (r = i.valHooks[f.type] || i.valHooks[f.nodeName.toLowerCase()], r && "get" in r && (u = r.get(f, "value")) !== t ? u : (u = f.value, "string" == typeof u ? u.replace(re, "") : null == u ? "" : u)) : void 0
       }
   });
   i.extend({
       valHooks: {
       ...
       propHooks: {
           tabIndex: {
               get: function(n) {
                   ...
                   return t ? parseInt(t, 10) : ue.test(n.nodeName) || fe.test(n.nodeName) && n.href ? 0 : -1
               }
           }
       }
   });
   ...
   i.event = {
       ...
       fix: function(n) {
           ...
           var e, o, s, u = n.type,
               f = n,
               t = this.fixHooks[u];
           for (t || (this.fixHooks[u] = t = oe.test(u) ? this.mouseHooks : ee.test(u) ? this.keyHooks : {}), s = t.props ? this.props.concat(t.props) : this.props, n = new i.Event(f), e = s.length; e--;) o = s[e], n[o] = f[o];
   ...
   i.each({
       ...
       i.fn[n] = function(r, u) {
           ...
           return "Until" !== n.slice(-5) && (u = r), u && "string" == typeof u && (f = i.filter(u, f)), this.length > 1 && (ce[n] || (f = i.unique(f)), he.test(n) && (f = f.reverse())), this.pushStack(f)
       }
   });
   i.extend({
   ...
   var yr = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
       ...
       be = vr(r),
       si = be.appendChild(r.createElement("div"));
   e.optgroup = e.option;
   ...
   i.fn.extend({
       ...
       html: function(n) {
           return i.access(this, function(n) {
               var r = this[0] || {},
                   f = 0,
                   o = this.length;
               if (n === t) return 1 === r.nodeType ? r.innerHTML.replace(le, "") : t;
               if (!("string" != typeof n || ve.test(n) || !i.support.htmlSerialize && pr.test(n) || !i.support.leadingWhitespace && ei.test(n) || e[(br.exec(n) || ["", ""])[1].toLowerCase()])) {
                   n = n.replace(wr, "<$1><\/$2>");
                   try {
       ...
       domManip: function(n, t, r) {
           ...
           var h, f, c, o, v, s, e = 0,
               ...
               a = n[0],
               y = i.isFunction(a);
           if (y || !(1 >= l || "string" != typeof a || i.support.checkClone) && ye.test(a)) return this.each(function(i) {
               var u = p.eq(i);
           ...
           if (l && (s = i.buildFragment(n, this[0].ownerDocument, !1, !r && this), h = s.firstChild, 1 === s.childNodes.length && (s = h), h)) {
               ...
               if (c)
                   for (v = o[o.length - 1].ownerDocument, i.map(o, tu), e = 0; c > e; e++) f = o[e], dr.test(f.type || "") && !i._data(f, "globalEval") && i.contains(v, f) && (f.src ? i._evalUrl(f.src) : i.globalEval((f.text || f.textContent || f.innerHTML || "").replace(we, "")));
               s = h = null
           }
           return this
       }
   ...
   i.extend({
       clone: function(n, t, r) {
           ...
           if (i.support.html5Clone || i.isXMLDoc(n) || !pr.test("<" + n.nodeName + ">") ? o = n.cloneNode(!0) : (si.innerHTML = n.outerHTML, si.removeChild(o = si.firstChild)), !(i.support.noCloneEvent && i.support.noCloneChecked || 1 !== n.nodeType && 11 !== n.nodeType || i.isXMLDoc(n)))
               for (f = u(o), s = u(n), e = 0; null != (h = s[e]); ++e) f[e] && ke(h, f[e]);
           if (t)
               if (r)
       ...
       buildFragment: function(n, t, r, f) {
           ...
           for (s && a.removeChild(s), i.support.appendChecked || i.grep(u(c, "input"), de), v = 0; o = c[v++];)
   ...
   i.extend({
       ...
       style: function(n, r, u, f) {
           if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
               ...
               if (s = typeof u, "string" === s && (o = ro.exec(u)) && (u = (o[1] + 1) * o[2] + parseFloat(i.css(n, r)), s = "number"), !(null == u || "number" === s && isNaN(u) || ("number" !== s || i.cssNumber[h] || (u += "px"), i.support.clearCloneStyle || "" !== u || 0 !== r.indexOf("background") || (c[r] = "inherit"), e && "set" in e && (u = e.set(n, u, f)) === t))) try {
                   c[r] = u
               } catch (l) {}
           }
       },
   ...
   n.getComputedStyle ? (v = function(t) {
       ...
       var s, e, o, h = r || v(n),
           u = h ? h[i] : t,
           f = n.style;
       return null == u && f && f[i] && (u = f[i]), lt.test(u) && !no.test(i) && (s = f.left, e = n.runtimeStyle, o = e && e.left, o && (e.left = n.currentStyle.left), f.left = "fontSize" === i ? "1em" : u, u = f.pixelLeft + "px", f.left = s, o && (e.left = o)), "" === u ? "auto" : u
   });
   i.each(["height", "width"], function(n, r) {
       i.cssHooks[r] = {
           get: function(n, u, f) {
               return u ? 0 === n.offsetWidth && to.test(i.css(n, "display")) ? i.swap(n, uo, function() {
                   return lu(n, r, f)
               }) : lu(n, r, f) : t
           },
           set: function(n, t, u) {
   ...
   i.fn.extend({
       ...
       serializeArray: function() {
           return this.map(function() {
               ...
               var n = this.type;
               return this.name && !i(this).is(":disabled") && so.test(this.nodeName) && !oo.test(n) && (this.checked || !oi.test(n))
           }).map(function(n, t) {
               var r = i(this).val();
           ...
           var l, a, e, d, g, v, y, p, u = i.ajaxSetup({}, r),
               ...
               f = {
                   ...
                   getResponseHeader: function(n) {
                       ...
                       if (2 === o) {
                           if (!p)
                               for (p = {}; t = co.exec(d);) p[t[1].toLowerCase()] = t[2];
                           t = p[n.toLowerCase()]
                       }
       ...
       stop: function(n, r, u) {
           ...
           return "string" != typeof n && (u = r, r = n, n = t), r && n !== !1 && this.queue(n || "fx", []), this.each(function() {
               ...
               if (t) r[t] && r[t].stop && f(r[t]);
                   ...
                   for (t in r) r[t] && r[t].stop && bo.test(t) && f(r[t]);
   ...
   i.fn.offset = function(n) {
       ...
       var r, e, f = {
           ...
           u = this[0],
           s = u && u.ownerDocument;
       if (s) return r = s.documentElement, i.contains(r, u) ? (typeof u.getBoundingClientRect !== o && (f = u.getBoundingClientRect()), e = hf(s), {
...
var googleCaptchaSiteKey = "6LdM-rUaAAAAAGt03Gb2u5XNu9W5Emyn5le13uJV";
